...
const obtenerProduccion = async () => {
  console.log("OBTENER PRODUCCION");

  let contador2 = 200;

  const comandos2 = [];
  comandos2.push(`RD DM250`);

  const PLC = new ClientProduccion("192.168.0.10", 8501, comandos2);
...
module.exports = { ClientProduccion, obtenerProduccion };
